...
LOCAL_LDLIBS += -llog
LOCAL_CFLAGS += -I'extern/libil2cpp/il2cpp/libil2cpp' -DID='"mplighting"' -DVERSION='"0.1.1"' -I'./shared' -I'./extern' -isystem'extern/codegen/include'
